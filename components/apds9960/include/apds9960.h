 ...
 *     - ESP_FAIL Fail
 */
esp_err_t apds9960_enable_proximity_interrupt(apds9960_handle_t sensor,
		bool en);
 ...
 *
 * @param sensor object handle of apds9960
 * @param apds9960 register to set
 * @param apds9960 register value
 *
 * @return
 *     - ESP_OK Success
 *     - ESP_FAIL Fail
...
esp_err_t apds9960_set_gesture_Int_Enable(apds9960_handle_t sensor, uint8_t enable);
